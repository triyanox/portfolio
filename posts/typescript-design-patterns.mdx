...
thumbnailUrl: '/static/images/typescript-design-patterns.png'
tags: ['Typescript', 'Design Patterns', 'Programming']
author: 'Mohamed Achaq'
readTime: '10'
link: 'typescript-design-patterns'
---
...
and then you can use it like this to make as much as you want of cars as log as you provide the type
