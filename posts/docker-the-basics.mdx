...
thumbnailUrl: '/static/images/docker-the-basics.png'
tags: ['Docker', 'Mongodb', 'Backend']
author: 'Mohamed Achaq'
readTime: '8'
link: 'docker-the-basics'
---

<Imagecomponent
  src={`/static/images/run-everything-from-a-docker-container.png`}
...
And using Docker you don't have to deal with all the junk add by virtualized operating systems that may consume a lot of resources,
...
(Docker Hub)[https://hub.docker.com/] is a website that allows you to share your Docker images with the community, and this type of services known as **registries** or **central registries**, and you can integrate them in you CI/CMD
...
```bash:bash
docker tag flask-docker-boilerplate achaq/flask-docker-boilerplate:latest
```
...
```bash:bash
docker push achaq/flask-docker-boilerplate:latest
```
