...
[Docker Hub website](https://hub.docker.com/) is a website that allows you to share your Docker images with the community, and this type of services known as **registries** or **central registries**, and you can integrate them in you CI/CMD
