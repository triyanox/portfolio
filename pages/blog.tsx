      ...
      <section className="mt-24 flex w-full flex-col justify-center gap-y-4 px-8 md:px-16 ">
        <div className="flex flex-col items-start justify-center">
          ...
          <input
            ...
            className=" w-full rounded-lg bg-gray-100 px-11 py-8 text-lg font-medium text-black placeholder-gray-500 ring-gray-500 ring-offset-4 ring-offset-white transition duration-300 focus-within:outline-none focus-within:ring-2 focus-within:ring-gray-500 hover:ring-2 hover:ring-gray-500  focus:outline-none  focus:ring-2 focus:ring-gray-500 disabled:text-gray-400 disabled:ring-0 group-hover:ring-2  group-hover:ring-gray-500 group-focus:ring-2 group-focus:ring-gray-800 dark:bg-zinc-800 dark:text-white  dark:ring-offset-gray-900 dark:disabled:text-gray-500"
            placeholder="Search"
          />
        </div>
