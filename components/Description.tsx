  ...
  return (
    <AnimatePresence exitBeforeEnter>
      <motion.div
        ...
        className="flex w-full flex-col items-start justify-center rounded-[30px] bg-gray-50 p-8 dark:bg-zinc-900 "
      >
        ...
        {props.tools !== undefined && (
          <div>
            ...
            <div className=" mt-4 flex flex-row justify-start gap-3 text-2xl text-gray-600 dark:text-gray-400 md:text-3xl md:text-3xl">
