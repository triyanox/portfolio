...
const Navbar = () => {
  ...
  return (
    <section className="fixed top-0 z-50 flex w-full flex-row items-center justify-between bg-white bg-opacity-70 px-8 py-4 backdrop-blur-xl dark:bg-black dark:bg-opacity-70 dark:backdrop-blur-xl md:px-16">
      <motion.button
